...
import podcastData from "assets/images/Podcast-Data/data";
...
const BloggerDetailsPage = () => {
  ...
  const currentPodcasts = podcastData.slice(startIndex, endIndex);
  return (
    <>
      <Header />
      <div className="bg-white-A700 flex flex-col font-publicsans gap-10 items-center justify-start mx-auto w-full">
        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div id="targetSection" className="flex flex-col items-start justify-start max-w-[1106px] mt-[100px] mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-col items-center justify-start mt-5 w-full">
              <div className="md:gap-5 gap-[22px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 justify-center min-h-[auto] w-full">
                {currentPodcasts.map((podcast) => (
                  <div key={podcast.id} className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-[13px] rounded-[5px] shadow-bs2 w-full">
            ...
            <div className="flex flex-row items-center justify-start mt-[50px] w-1/5 md:w-full">
              <Text
                className={`bg-indigo-901 flex h-10 items-center justify-center rounded-[50%] text-center text-lg text-white-A700 w-10 ${page === 1 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
              ...
              <Text
                className={`bg-white-A700 flex h-10 items-center justify-center ml-5 rounded-[50%] text-center text-indigo-901 text-lg w-10 ${endIndex >= podcastData.length ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
              ...
              <div className="flex flex-row gap-[15px] items-start justify-between ml-10 w-[34%]">
                <Text
                  className={`text-indigo-901 text-lg ${page === 1 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                ...
                <Text
                  className={`text-indigo-901 text-lg ${endIndex >= podcastData.length ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                  size="txtPublicSansLight18Indigo901"
                  onClick={() => setPage(page + 1)}
                >
                  Next
